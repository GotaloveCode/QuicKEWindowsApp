...
namespace QuicKE.Client
{
    public class LocationResult
    {
        ...
        {
            return new AdHocMappablePoint((decimal)this.Location.Coordinate.Point.Position.Latitude, (decimal)this.Location.Coordinate.Point.Position.Longitude, "Location");
        }
    }
}
